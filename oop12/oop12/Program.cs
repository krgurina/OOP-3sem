...
namespace oop12
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            GKSFileManager.CopyFiles(@"F:\лабы\ООП", @"F:\лабы\ООП\labs\oop12\oop12\GKSFiles", @"F:\лабы\ООП\labs\oop12\oop12\GKSInspec");
            GKSFileManager.ZipFiles(@"F:\лабы\ООП\labs\oop12\oop12\GKSInspec\GKSFiles", @"F:\лабы\ООП\labs\oop12\oop12\GKSInspec\GKSFiles.zip", @"F:\лабы\ООП\labs\oop12\oop12\ForZip");
            //GKSLog.Count();
