...
namespace oop10
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Book book4 = new Book("Стихотворения и поэмы", "Маяковский", 1995, 180, 150);
            Book book5 = new Book("Анна Каренина","Толстой", 1878, 190, 17);
            Book book6 = new Book("Стихотворения и поэмы", "Есенин", 1998, 900, 19);
            Book book7 = new Book("Вечер", "Ахматова", 1912, 160, 14);
            Book book8 = new Book("Дневники", "Пришвин", 1936, 500, 11);
            Book book9 = new Book("Моя жизнь", "Чехов", 1896, 320, 31);
            Book book10 = new Book("Малое издание сочинений", "Бродский", 1967, 7550, 56);
